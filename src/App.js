            ...
            <React.Fragment>
                <Routes>
                    <Route element={<MainLayout/>}>
                        ...
                        {/*어드민 환경설정 페이지  */}
                        <Route path="/admin/configuration" element={<AdminRouter authenticated={role} component={<ConfigurationPage/>}/>}/>

                        {/*어드민 보고서 페이지 */}
                        <Route path="/admin/report" element={<AdminRouter authenticated={role} component={<Report/>}/>}/>

                        {/* 사원 관리 페이지 */}
                        <Route path='/admin/emp-management' element={<AdminRouter authenticated={role} component={<EmpManagement/>}/>}/>
