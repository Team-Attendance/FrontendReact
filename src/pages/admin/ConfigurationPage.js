...
import AuthList from "../../components/configuration/AuthList";
import ResultList from "../../components/configuration/ResultList";
export function ConfigurationPage() {
    const { empAllInfo } =  useSelector((state) => state.empAllInfo)
    const { empAllsInfo } = useSelector((state) => state.empAllsInfo)
                   ...
                   <div className="vbox1">
                    ...
                    <div className="vbox2">
                        <div className="vbox2-1">
                            ...
                            <span className="empinfo">직급</span>
                               ...
                               <div className="authresult">
                                <AuthList empAllInfo = {empAllInfo}/>
                        ...
                        <div className="vbox2-1">
                            ...
                            <div className="authresult">
                            <ResultList empAllsInfo = {empAllsInfo}/>
