                        ...
                        <div style={{ width: '76%' }}>
                            <div style={{ display: 'flex', height: '430px', marginBottom: '25px' }}>
                                <div style={{ width: '66%', padding: '20px 20px', height: '100%', border: '1px solid gray', marginRight: '15px', borderRadius: '7px' }}>
                                    <div style={{ marginBottom: '15px' }}>
                                        ...
                                        <div style={{ display: 'flex' }}>
                                            <Link to="/admin/approval/leave" style={{width: '100%'}}>
                                            ...
                                            <Link to="/admin/approval/odd" style={{width: '100%'}}>
                                                <div style={{ height: '45px', border: '1px solid lightgray', borderRadius: '8px', backgroundColor: '#36A2EB', marginLeft: '7px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            <div style={{ height: '390px', display: 'flex' }}>
                                ...
                                <div style={{ border: '1px solid gray', width: '34%', padding: '20px 20px', borderRadius: '7px' }}>
                                    <h2 style={{ fontWeight: 'bold', fontSize: '0.8rem', marginBottom: '5px', lineHeight: '25px' }}>금일 근무 현황</h2>
                                    <div style={{ height: 'calc(100% - 30px)', border: '1px solid lightgray' }}>
