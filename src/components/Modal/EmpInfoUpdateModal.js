...
const EmpInfoUpdateModal = ({empInfoDetail, closeModal}) => {
    ...
    function handleUpdate(e) {
        ...
        window.location.href = `${empInfoDetail.empNo}`
    }
                    ...
                    <div className="EmpInfoUpdateModall-ul">
                        ...
                        <li className="infoLi">
                            ...
                            <input className="infoInput" required onChange={handleEmpName}
                                   defaultValue={empInfoDetail.empName}></input></li>
                        <li className="infoLi">
                            <div className="infoLabel">사번</div>
                            <div className="infoInput" readOnly>{empInfoDetail.empNo}</div>
                        </li>
                        <li className="infoLi">
                            <div className="infoLabel">부서 이름</div>
                        ...
                        <li className="infoLi">
                            ...
                            <select className="infoInput" name='deptName' required='직급을 선택하세요'
                                    onChange={handleEmpPosition}>
                        ...
                        <li className="infoLi">
                            ...
                            <input className="infoInput" required onChange={handleEmpEmail}
                                   defaultValue={empInfoDetail.empEmail}></input></li>
                        <li className="infoLi">
                            <div className="infoLabel">휴대폰</div>
                            <input className="infoInput" required onChange={handleEmpCellPhone}
                                   defaultValue={empInfoDetail.empCellPhone}></input></li>
                        ...
                        <li className="infoLi">
                            ...
                            <input className="infoInput" required onChange={handleEmpContactList}
                                   defaultValue={empInfoDetail.empContactList}></input></li>
                        <li className="infoLi">
