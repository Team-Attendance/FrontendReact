...
const EmpInfoUpdateModal = ({empInfoDetail, closeModal}) => {
    ...
    const [empPwd, setEmpPwd] = useState(empInfoDetail.empNo);
    ...
    const [empBirth, setEmpBirth] = useState(empInfoDetail.empBirth);
    const [empFirstDayOfWork, setEmpFirstDayOfWork] = useState(empInfoDetail.empFirstDayOfWork);
        ...
        if (deptName == null) {
            ...
            api.postAdmUpdate(formData).then((res)=>{
                let result = res.data;
                    if (result) {
                        alert("사원수정이 완료 됐습니다.");
                        window.location.href = `/admin/report/${empInfoDetail.empNo}`;
                        closeModal();
                    }else {
                        alert("정보 수정에 실패했습니다.");
                    }
                ...
                <div className="reginfoContent">
                    <div className="reginfoUl">
                        <li className="reginfoLi">
                            ...
                            <div className="reginfoInput">{empInfoDetail.empNo}</div>
                        </li>
                        <li className="reginfoLi">
                        ...
                        <li className="reginfoLi">
                            ...
                            <input className="reginfoInput" type="date" name='empBirth'
                                   value={empBirth} onChange={handleEmpBirth}></input>
                        </li>
                        <li className="reginfoLi">
                            <div className="reginfoLabel"> 입사일</div>
                            <input className="reginfoInput" type="date" name='empFirstDayOfWork'
                                   value={empFirstDayOfWork} onChange={handleEmpFirstDayOfWork}></input>
                        </li>
